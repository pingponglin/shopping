<template>
          ...
          <div class="user-order">
            ...
            <div class="am-cf am-padding">
              <div class="am-fl am-cf">
                <strong class="am-text-danger am-text-lg">退货管理</strong>
              </div>
            </div>
            <hr />
            <div class="am-tabs am-tabs-d2 am-margin" data-am-tabs>
              <ul class="am-avg-sm-5 am-tabs-nav am-nav am-nav-tabs">
                <li class="am-active"><a href="#tab1">退货管理</a></li>
              ...
              <div class="am-tabs-bd">
                  ...
                  <div class="order-top">
                    <div class="th th-item">
                      <td class="td-inner" style="position: relative;left: 81px;">商品</td>
                    </div>
                    <div class="th th-operation">
                      <td class="td-inner" style="position: relative;left: 30px;">交易金额</td>
                    </div>
                  ...
                  <div class="order-main" >
                    <div class="order-list">
                      ...
                      <div class="order-status2">
                          <div v-for="fahuo in orlist" :key="fahuo.Ordertuihuoid">
                        <div class="order-title" style="background-color: #F5F5F5;">
                          <span>成交时间：{{fahuo.Ordertuihuodate | dateFormat}}</span>
                          <!--    <em>店铺：小桔灯</em>-->
                        </div>
                          ...
                          <div class="order-left">
                            <ul class="item-list">
                              <li class="td td-item">
                                <div class="item-pic">
                                  <a href="#" class="J_MakePoint">
                                    <img
                                      :src="'http://81.68.132.153:7070/img/'+fahuo.Good.GoodImage"
                                ...
                                <div class="item-info">
                                  <div class="item-basic-info">
                                    <a href="#">
                                      <p>
                                        {{fahuo.Good.GoodfuName}}
                                      </p>
                                      <!-- <p class="info-little">
                                         类型：{{fahuo.Goodtypetwo.Goodtypetwoname}}
                                      </p> -->
                                    </a>
                                  </div>
                                </div>
                              ...
                              <li class="td td-price">
                                <div class="item-price">￥{{fahuo.Order.Ordersum}}.00</div>
                              </li>
                              <li class="td td-number">
                                <div class="item-number" style="position: relative;left: 49px;">￥{{fahuo.Ordertuihuomoneys}}</div>
                              </li>
                              <li class="td td-operation">
                                <div class="item-operation">
                                  <div class="item-number" style="position: relative;left: 51px;">{{fahuo.Ordertuihuostatus}}</div>
                                  <a href="#" @click="faUserdzhu(fahuo.Ordertuihuostatus)" style="position: relative;
    left: 51px;">查看物流</a>
                                </div>
                              </li>
                            </ul>
                          ...
                          <div class="order-right">
                            <div class="move-right">
                              <li class="td td-change">
                                <div class="am-btn am-btn-danger anniu" @click="ordertuik(fahuo.Orderid)" style="width: 91px;height: 38px;text-align: center;line-height: 36px;position: relative;left: 49px;">
                                  退货去向
                                </div>
                              </li>
                            </div>
  ...
  <el-steps  direction="vertical" :active="ding" finish-status="success">
    <el-step title="退货订单已提交,待处理"></el-step>
    <el-step title="退货订单已拒绝"></el-step>
    <el-step title="退货订单已签收,期待再次为您服务"></el-step>
  </el-steps>
</div>
...
methods:{
    //退货数据
ordertuihuolist(){
this.$axios.get('/api/Food/ordertuihuouserid?id='+this.userid).then(s=>{
    if (s.data!="") {
        this.orlist=s.data;
